...
namespace SIRA_Notificaciones.dal
{
    class siraPeticiones
    {
        ...
        public void pruebaSimple()
        {
            ...
            //ICredentials credentials = new NetworkCredential("SAT970701NN3", "i1yzMzAa3RvVgMzNAmTnL0hvVmSRTYDOpmuTrO0+REFMnCTj+k+LFHmZRtgkMkEq", "https://*");
            ...
            try
            {
                ...
                objEntradaSimple.informacionGeneral.fechaRegistro           = Convert.ToDateTime("06/02/2020 10:00:00");
                ...
                objEntradaSimple.informacionIngreso.fechaFinDescarga        = Convert.ToDateTime("05/02/2020 18:30:00");
                objEntradaSimple.informacionIngreso.fechaInicioDescarga     = Convert.ToDateTime("05/02/2020 18:30:00");
                objEntradaSimple.informacionIngreso.peso = 400;

                objEntradaSimple.informacionIngreso.condicionCarga = 1;
                objEntradaSimple.informacionIngreso.observaciones = "Prueba de envio WS al 10/02/2020";
        ...
        public void IngresoSinID()
        {
            ...
            try
            {
                ...
                objInfoGeneral.fechaRegistro = Convert.ToDateTime("06/02/2020 10:00:00");
                ...
                objIngresoSinId.informacionIngreso.fechaFinDescarga = Convert.ToDateTime("05/02/2020 18:30:00");
                objIngresoSinId.informacionIngreso.fechaInicioDescarga = Convert.ToDateTime("05/02/2020 18:30:00");
                objIngresoSinId.informacionIngreso.peso = 400;
                objIngresoSinId.informacionIngreso.condicionCarga = 1;
                objIngresoSinId.informacionIngreso.observaciones = "Prueba de envio WS IngresoSinId al 06/02/2020 10:16";

                //----------Transporte
                wsSira.InformacionDeTransporte objTransporte = new wsSira.InformacionDeTransporte();
                objTransporte.numeroVueloBuqueViajeImo = "1";
                objTransporte.fechaHoraDeArribo = Convert.ToDateTime("06/02/2020 11:00:00");
                ...
                //Lanzamos peticion al WS de Sira
                objRespuesta = ws.ingresoSinID(objIngresoSinId);
        ...
        public void IngresoFlujoAlterno()
        {
            ServicePointManager.ServerCertificateValidationCallback = delegate { return true; };
            wsSira.InformacionDeIngresoFlujoAlterno objIngresoFlujoAlterno = new wsSira.InformacionDeIngresoFlujoAlterno();
            Respuesta objRespuesta = new Respuesta();
            ...
            try
            {
                ...
                //----------Informacion general
                wsSira.InformacionOperacionGeneral objInfoGeneral = new wsSira.InformacionOperacionGeneral();
                objInfoGeneral.consecutivo      = "000000001";
                objInfoGeneral.idAsociado       = "000000001";
                objInfoGeneral.fechaRegistro    = Convert.ToDateTime("06/02/2020 10:00:00");
                objInfoGeneral.tipoMovimiento       = 4; // Ingreso sin Id
                objInfoGeneral.detalleMovimiento = 3; //Maritimo
                objInfoGeneral.tipoOperacion    = 1; // Importacion
                objInfoGeneral.cveRecintoFiscalizado = "0067";
                objIngresoFlujoAlterno.informacionGeneral = objInfoGeneral;

                //----------Informacion ingreso
                wsSira.InformacionIngreso objIngreso = new wsSira.InformacionIngreso();
                objIngreso.tipoMercancia = 1;
                objIngreso.fechaFinDescarga = Convert.ToDateTime("05/02/2020 18:30:00");
                objIngreso.fechaInicioDescarga = Convert.ToDateTime("05/02/2020 18:30:00");
                objIngreso.peso = 0;
                objIngreso.condicionCarga = 1;
                objIngreso.observaciones = "Ingreso de flujo alterno al 06/02/2020";


                //----------Transporte
                wsSira.InformacionDeTransporte objTransporte = new wsSira.InformacionDeTransporte();
                objTransporte.numeroVueloBuqueViajeImo = "1";
                objTransporte.fechaHoraDeArribo = Convert.ToDateTime("06/02/2020 18:00:00");
                objTransporte.tipoTransporte = "M";
                objTransporte.origenVueloBuque = "MEX";
                objTransporte.numeroManifiesto = "ABGH976285JJDFGW";
                objTransporte.caat = "6890";
                objTransporte.peso = 2800;
                objTransporte.ump = "KG";
                objTransporte.piezas = 280;
                objIngresoFlujoAlterno.transporte = objTransporte;
                ...
                objMater.umv = "M3";
                objMater.piezas = 760;
                objMater.idParcialidad = "000000001";
                objMater.secuencia = 1;
                objMater.observaciones = "EJEMPLO DE 1 CONTENEDOR. 1.SECUENCIA. 2 HOUSES ";
                ...
                objContenedor[0].guiaHouse = listaHouse;
                objMater.contenedor = objContenedor;
                objIngresoFlujoAlterno.guiaMaster = objMater;


                //Serializamos Objeto Request
                xmlRequest = ParseObjeto(objIngresoFlujoAlterno);

                //Lanzamos peticion al WS de Sira
                try
                {
                    objRespuesta = ws.ingresoFlujoAlterno(objIngresoFlujoAlterno);
                }
                catch (Exception ex)
                {
                    xmlResponse = ParseObjeto(ex.Message);
                ...
                Respuesta objRespuesta2 = new Respuesta();
            ...
            Inserta_Notificador(Int32.Parse(objIngresoFlujoAlterno.informacionGeneral.idAsociado), "ingreso flujo alterno", "Request", xmlRequest, xmlResponse, estadoPeticion);
        }
                
        public void Rechazo()
        {
            ServicePointManager.ServerCertificateValidationCallback = delegate { return true; };
            wsSira.InformacionDeRechazo objRechazo = new wsSira.InformacionDeRechazo();
            wsSira.Respuesta objRespuesta = new wsSira.Respuesta();
            ...
            try
            {
                ...
                objRechazo.informacionGeneral = new wsSira.InformacionOperacionGeneral();
                objRechazo.informacionGeneral.consecutivo       = "000000001";
                objRechazo.informacionGeneral.idAsociado        = "0000000564";
                objRechazo.informacionGeneral.fechaRegistro     = Convert.ToDateTime("06/02/2020 18:30:00");
                objRechazo.informacionGeneral.tipoMovimiento    = 0; 
                objRechazo.informacionGeneral.detalleMovimiento = 3;//Maritimo
                objRechazo.informacionGeneral.tipoOperacion = 1;//Importacion
                objRechazo.informacionGeneral.cveRecintoFiscalizado = "0067";

                wsSira.InformacionRechazo objInformacionRechazo = new wsSira.InformacionRechazo();
                objInformacionRechazo.clasificacionRechazo = "0";
                objInformacionRechazo.descripcionRechazo = "Descripcion rechazo";
                objInformacionRechazo.observaciones = "SIN OBSERVACIONES, prueba VUCEM Rechazo al 06/'6/2020";

                objRechazo.informacionRechazo = objInformacionRechazo;

                //Serializamos Objeto Request
                xmlRequest = ParseObjeto(objRechazo);

                //Lanzamos peticion al WS de Sira
                objRespuesta = ws.rechazo(objRechazo);
            ...
            Inserta_Notificador(Int32.Parse(objRechazo.informacionGeneral.idAsociado), "ingreso Parcial", "Request", xmlRequest, xmlResponse, estadoPeticion);
        }
